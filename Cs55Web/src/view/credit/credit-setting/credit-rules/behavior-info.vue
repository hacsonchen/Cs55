  ...
  <div class="behaviorInfo">
    ...
    <div class="ivu-table-wrapper body-bottom">
      <div class="ivu-table ivu-table-default ivu-table-border">
        ...
        <div class="ivu-table-body">
          <Form :model="tempAwardType1" ref="formDynamic7" :rules="rules" inline>
            <table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
              <tbody class="ivu-table-body">
            ...
            <tbody class="ivu-table-body">
              <template v-for="(row,i) in awardType2.uMSCoinAwardones">
                <tr class="ivu-table-row" :key="i+'-1'">
                  <td class="ivu-table-cell">
                    <Form :model="row" :ref="'formDynamic6-'+i" :rules="rules" inline>
                      <Row>
...
export default {
  ...
  data() {
    return {
      ...
      awardType2: {},
      rules: {
        limitAmount: [{ validator: validateNumber(), trigger: "change" }],
        oneLimit: [{ validator: validateNumber(), trigger: "change" }],
        coinAmount: [{ validator: validateNumber(), trigger: "change" }],
        dayAmount: [{ validator: validateNumber(), trigger: "change" }]
      }
    };
  },
  mounted() {
  ...
  methods: {
    ...
    handleSave() {
      ...
      postCoinStandardRule({
        ...
        coinAwards: [this.awardType2, this.awardType1]
    ...
    handleRemoveRow(type, index, i) {
      if (type === 2) {
        this.awardType2.commonAwardOnes.splice(i, 1);
      } else {
        this.awardType3.commonAwardOnes.splice(i, 1);
      }
    }
  }
};
