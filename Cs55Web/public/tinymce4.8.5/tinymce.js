  ...
  (function() {
    ...
    function WindowManager(editor) {
      ...
      var alert = function(message, callback, scope) {
        var win = getImplementation().alert(message, funcBind(scope || this, callback), closeWindow)
        addWindow(win)
      }
      var confirm = function(message, callback, scope) {
        var win = getImplementation().confirm(message, funcBind(scope || this, callback), closeWindow)
        addWindow(win)
      }
      var close = function() {
